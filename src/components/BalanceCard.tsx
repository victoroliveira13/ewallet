...
import { CARD_NUMBER_DISPLAY, MONTHLY_CHANGE_DISPLAY } from '../constants/wallet';
    ...
    <View className='bg-surface rounded-3xl p-6 mx-4'>
      ...
      <View className='mb-6'>
        ...
        <View className='flex-row items-center mt-2'>
          ...
          <Text className='text-primary text-sm'>{MONTHLY_CHANGE_DISPLAY}</Text>
        </View>
      </View>

      {/* Card number */}
      <View className='flex-row items-center justify-between'>
        <Text className='text-text-muted text-sm tracking-widest'>{CARD_NUMBER_DISPLAY}</Text>
